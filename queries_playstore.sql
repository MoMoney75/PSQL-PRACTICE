...
SELECT category, AVG(rating) FROM analytics GROUP BY category DESC;

--Find the name, price, and rating of the most expensive app with a rating that’s less than 3.
SELECT app_name,price, rating FROM analytics WHERE rating >= 4.8 ORDER BY reviews DESC LIMIT 1;
